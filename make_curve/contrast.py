...
if __name__ == '__main__':
    ...
    # 大面红外线光长条气泡
    # txt_paths = [r'E:\pycharmproject\cleantest\runs6\log\大面红外线光长条气泡_cleantest_200epochs_1.txt',
    #              r'E:\pycharmproject\cleantest\runs6\log\大面红外线光长条气泡_cleantest_200epochs_2.txt',
    #              r'E:\pycharmproject\cleantest\runs6\log\大面红外线光长条气泡_cleantest_200epochs_clean.txt',
    ...
    txt_paths = [r'E:\pycharmproject\cleantest\runs4\log\大面指纹脏污_cleantest_200epochs_1.txt',
                 ...
                 r'E:\pycharmproject\cleantest\runs1\log\大面指纹脏污_cleantest_200epochs_clean.txt',
    ...
    ax1.plot(x, train_losses[2], 'k', label='train_loss_clean_way1')  # 作y1 = x 图，并标记此线名为linear
    ax1.plot(x, train_losses[3], 'r', label='train_loss_clean_way2')  # 作y1 = x 图，并标记此线名为linear
    ...
    ax2.plot(x, val_pres[2], 'k', label='val_acc_clean_way1')  # 作y2 = x^2 图，并标记此线名为quadratic
    ax2.plot(x, val_pres[3], 'r', label='val_acc_clean_way2')  # 作y2 = x^2 图，并标记此线名为quadratic
    ...
    ax3.plot(x, test_pres[2], 'k', label='test_acc_clean_way1')  # 作y2 = x^2 图，并标记此线名为quadratic
    ax3.plot(x, test_pres[3], 'r', label='test_acc_clean_way2')  # 作y2 = x^2 图，并标记此线名为quadratic
